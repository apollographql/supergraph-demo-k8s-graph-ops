...
# inputs from apollographql/supergraph-demo/.scripts/build-matrix.sh
# for use in apollographql/supergraph-demo/.github/workflows/release.yml
# to bump image versions
